...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="mt-12 border-t border-border bg-card"><div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-8 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8"><p>© 2026 Rentalhub. Find your next place anywhere in Nigeria.</p><Link href="/admin" className="font-medium hover:text-foreground">Admin access</Link></div></footer>
    </div>
  )
}
